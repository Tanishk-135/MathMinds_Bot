...
- write the expression without using subscripts (eg x² -> x^2) and using sqrt instead of the actual radical sign (√x -> sqrt(x)) when you are writing "Graph of (expression in inline blocks)" so that it is feasible and correct format for generation of graphs.
